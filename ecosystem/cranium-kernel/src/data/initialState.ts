...
import { createConstitutionalPrinciples } from '../kernel/constitution';
...
// The runtime Prime Directives are canonical. Legacy constitutional records
// remain available as historical implementation principles, but the active
// directive set must be generated from the constitution module.
export const ACTIVE_CONSTITUTION = createConstitutionalPrinciples();
...
export function createInitialKernelState(): KernelState {
  return {
    ...
    constitutionalPrinciples: [...ACTIVE_CONSTITUTION, ...INITIAL_CONSTITUTION],
  };
}
