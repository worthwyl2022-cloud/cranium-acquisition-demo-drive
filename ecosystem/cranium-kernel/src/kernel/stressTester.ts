...
import { createConstitutionalPrinciples } from './constitution';
...
export class StressTestSuite {
  static runCampaign(
    ...
    let state: KernelState = {
      ...
      constitutionalPrinciples: createConstitutionalPrinciples(),
    };
        ...
        if (category === 'IDENTITY_SPOOFING') {
          ...
          req = {
            ...
            evidence: [
              {
                id: `ev_spoof_${i}`,
                uri: `urn:cranium:test-evidence:${rng.hex(16)}`,
